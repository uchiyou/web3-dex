...
import { useOrderBook, usePlaceOrder, useWalletBalance } from '@/hooks/useDex'
...
export default function TradePage() {
  ...
  const { bids, asks } = useOrderBook(pairId)
  const { balance, formatted, symbol } = useWalletBalance()
  
  // Mock recent trades
  const recentTrades = [
    { id: '1', price: 1850.42, quantity: 2.5, side: 'buy', time: '12:34:56' },
    { id: '2', price: 1851.00, quantity: 1.2, side: 'sell', time: '12:34:55' },
    { id: '3', price: 1850.80, quantity: 0.8, side: 'buy', time: '12:34:54' },
    { id: '4', price: 1850.20, quantity: 3.1, side: 'sell', time: '12:34:53' },
    { id: '5', price: 1849.50, quantity: 1.5, side: 'buy', time: '12:34:52' },
  ]
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-4">
            ...
            <Card className="p-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h2 className="text-lg font-semibold text-white">ETH/USDT</h2>
                  <p className="text-2xl font-bold text-white">$1,850.42</p>
                  ...
                  {['1H', '4H', '1D', '1W'].map((tf) => (
                    <button
                      ...
                      className={`px-3 py-1 rounded text-sm ${
                        tf === '1H' ? 'bg-primary-500 text-white' : 'bg-dark-200 text-gray-400'
                      }`}
                    >
                      {tf}
                    </button>
